...
- on Windows (cmd)
```
git clone https://github.com/pjaglom/kickstart-modular.nvim.git %userprofile%\AppData\Local\nvim\ 
```

- on Windows (powershell)
```
git clone https://github.com/pjaglom/kickstart-modular.nvim.git $env:USERPROFILE\AppData\Local\nvim\ 
```
